...
- short_time<br />
  with short_time = True, starts motion estimation at the block size of 8x8 and gradually refines it to 2x2 (optimized for maximum spatial resolution), short_time = False starts motion estimation at 16x16 and gradually refines it to 4x4 (optimized for maximum frequency resolution). short_time = False is meant for Deringing and short_time = True is for Destaircase and Deblocking
