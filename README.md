...
ref = Oyster.Basic(clip, Oyster.Super(clip))
clip = Oyster.Destaircase(clip, ref, block_step=2)
clip = Oyster.Deringing(clip, ref, block_step=2)
```
...
```python
ref = Oyster.Basic(clip, Oyster.Super(clip))
clip = Oyster.Destaircase(clip, ref, block_step=2, lowpass="0.0:1024 1.0:1024")
clip = Oyster.Deringing(clip, ref, sigma=24.0, h=12.8, block_step=2, lowpass="0.0:1024 1.0:1024")
```
...
```python
ref = Oyster.Basic(clip, Oyster.Super(clip))
clip = Oyster.Destaircase(clip, ref, sigma=24.0, block_step=2)
clip = Oyster.Deringing(clip, ref, sigma=24.0, h=12.8, block_step=2)
```
...
```python
ref = Oyster.Basic(clip, Oyster.Super (clip))
clip = Oyster.Deblocking(clip, ref, block_step=2)
clip = Oyster.Deringing(clip, ref, sigma=24.0, h=10.8, block_step=2)
```
